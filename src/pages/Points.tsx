 ...
 * @LastEditTime: 2024-02-29 11:33:13
 * @Author: John
 */
import "./Points.scss";
import "./Points-m.scss";
          ...
          {!isSmallScreen || !isMobile ? (
            <>
              <div className="introduce">
                ...
                <p>
                  Invite your friends to join a Bitcoin layer2 party. Earn
                  points, get exclusive rewards and share the fun! Let's make
                  the Bitcoin ecosystem a better place!
                </p>
              </div>
              ...
              <div className="taskPart">
                <TaskCoverImg
                  coverImg={point_task1_img}
                  title="Know B² Network"
                />
              ...
              <div className="taskPart">
                <TaskCoverImg
                  coverImg={point_task2_img}
                  title="Share B² Network"
                />
                <ul className="tasklist">
                  <TaskItem
                    type={2}
              ...
              <div className="taskPart">
                ...
                <ul className="tasklist">
                  ...
                  <span className="tasklist_des">
                    ...
                    ensure that your Bitcoin address is connected before
                    proceeding?
                  </span>
                </ul>
              </div>
