...
const UniSat = () => {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        console.log("values.satoshis * BTC_Unit_Converter",values.satoshis * BTC_Unit_Converter)
        if (sending) return
    ...
    return <>
        ...
        <div className="space-y-1 mt-10">
            ...
            <div className='flex items-center'>
                <Badge variant="default" className='mr-5'>UniSat</Badge>
                <h4 className="text-sm font-medium leading-none">Injected Provider {unisatInstalled ? 'DOES' : 'DOES NOT'} Exist</h4>
            </div>
        </div>

        {(!connected && unisatInstalled) &&
            <Button className='mt-5' disabled={connected} onClick={async () => {
                ...
                <div>
                    <div>
                        ...
                        <div className="w-full flex h-5 items-center text-sm my-2">
                            ...
                            <Separator className='mx-2' orientation="vertical" />
                            <div className='ml-auto'> {balance.total / BTC_Unit_Converter}</div>
                        </div>
